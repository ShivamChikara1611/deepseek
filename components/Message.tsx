...
const Message = ({ role, content }) => {
    return (
        <div className='flex flex-col items-center w-full max-3xl text-sm'>
                ...
                <div className={`group relative flex max-w-2xl py-3 rounded-xl ${role === 'user' ? 'bg-[#414158] px-5' : 'gap-3'}`}>
                    ...
                    </div>
                    {
                        role === 'user' ? (
                            ...
                            <>
                            <Image alt='' src={assets.logo_icon} className='w-9 h-9 p-1 border border-white/15 rounded-full'/>
